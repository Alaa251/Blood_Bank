...
import com.example.blood_bank_2022.Email.JavaMailApi;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
 ...
 private List<User> userList ;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(user.getProfillepictureur1()).into(holder.userProfileImage);
...
public Button emailNow ;
    ...
    private void addNotifications(String receiverId , String senderId){
        ...
        String dete = DateFormat.getDateInstance().format(new Date());
        HashMap<String,Object> hashMap =new HashMap<>();
        hashMap.put("receierId", receiverId);
        hashMap.put("senderId" , senderId);
        hashMap.put("text" , "Sent you an email , Kindly check it out !");
        hashMap.put("date",dete);
