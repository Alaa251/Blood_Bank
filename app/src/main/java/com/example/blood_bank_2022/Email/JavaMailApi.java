package com.example.blood_bank_2022.Email;
...
public class JavaMailApi extends AsyncTask<Void,Void,Void> {
    ...
    private String emil, subject, message;

    public JavaMailApi(Context context, String emil, String subject, String message) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            mimeMessage.addRecipients(Message.RecipientType.TO, String.valueOf(new InternetAddress()));
