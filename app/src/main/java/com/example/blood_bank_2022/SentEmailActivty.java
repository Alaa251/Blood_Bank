...
public class SentEmailActivty extends AppCompatActivity {
private RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_email_activty);
...
recyclerView = findViewById(R.id.recyclerView);
        ...
        userAdapter = new UserAdapter(SentEmailActivty.this, userList);
